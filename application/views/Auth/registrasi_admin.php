                            ...
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <form method="post" action="<?= base_url('Admin/login_admin'); ?>">
                                        ...
                                        <div class="col-md-12 mb-3">
                                            <div class="form-floating">
                                                <input class="form-control" id="nama_petugas" name="nama_petugas" type="text" placeholder="Enter your last name" />
                                                <label for="inputLastName">Nama Petugas</label>
                                    ...
                                    <div class="card-footer text-center py-3">
                                        <div class="small"><a href="<?= base_url('Admin/')?>">Have an account? Go to login</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
